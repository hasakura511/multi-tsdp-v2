...
path='C:\Users\Hidemi\Documents\GitHub\multi-tsdp\data\margins\\'
filename=path+date+'_ibmargins.csv'
margins=pd.concat([im,mm],axis=1)
margins.index.name='ibsym'
margins.to_csv(filename, index=True)
